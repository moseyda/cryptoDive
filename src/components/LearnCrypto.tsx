...
const ARTICLES = [
  { id: 1, anchor: 'what-is-crypto', title: 'What is cryptocurrency?', desc: 'Digital money using cryptography to secure transactions on decentralised networks.' },
  ...
  { id: 6, anchor: 'crypto-risks', title: 'What are the risks of crypto?', desc: 'High volatility, scams, and changing regulations mean you should invest carefully.' },
];
