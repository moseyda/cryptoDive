import LiveActivityBackground from './LiveActivityBackground';
...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 flex flex-col items-center justify-center text-center px-4 w-full max-w-[1728px] mx-auto min-h-[800px]">
      ...
      {/* Dynamic Pop-up Trade Notifications */}
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-10">
          <button className="bg-[#00ffa0] text-black text-[20px] md:text-[24px] font-semibold px-12 py-3 rounded-[60px] hover:bg-[#00e690] transition-transform transform hover:scale-105 active:scale-95 duration-200">
            Get Started
          </button>
          <button className="border-2 border-[#00ffa0] text-white text-[20px] md:text-[24px] font-semibold px-12 py-3 rounded-[60px] hover:bg-[#00ffa0]/10 transition-transform transform hover:scale-105 active:scale-95 duration-200">
            Start Trading
          </button>
        </div>
      </div>
